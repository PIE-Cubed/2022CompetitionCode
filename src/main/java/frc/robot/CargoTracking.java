...
public class CargoTracking {
	...
	private static final double cI = 0.0037; //0.001
	private static final double cD = 0.0000;

	// Integrator limits
	private static final double MIN_INTEGRATOR = -0.08; //-0.05
	private static final double MAX_INTEGRATOR =  0.08; // 0.05
	...
	private void faceCargo() {
		...
		if (isNotFull == true) {
			...
			// Starts rotating
			drive.teleopRotate(-1 * m_CargoCalculatedPower);
		}
		else {
